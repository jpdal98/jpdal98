...
<p>Sou formado em Engenharia de Software pela Universidade Federal do Ceará. Atualmente tenho 3+ anos de experiência com a área de desenvolvimento de software. Já trabalhei com: HTML, CSS, JavaScript, Jquery, Bootstrap, TypeScript, Vue, JSP, Java, Spring (mvc, boot, data, security, etc.), Struts, JDBC, JPA/Hibernate, Bancos de Dados Relacionais (PostgreSql, MySQl, DB2, Oracle e SQL Server) e não relacionais (MongoDB), Maven, XML, JasperReports, Ireport, Json, Junit, Mockito, Git, Tortoise, GitHub, GitLab, BitBucket e Metodologias Ágeis (Scrum e Kanban).</p>  
<br/>
