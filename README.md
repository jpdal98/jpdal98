<h1 align="center">Olá, tudo bem!? meu chamo João Pedro!</h1>
<p>Olá, tudo bem! Me chamo João Pedro. Sou formado em Engenharia de Software pela Universidade Federal do Ceará. Atualmente tenho 3+ anos de experiência com a área de desenvolvimento de software. Já trabalhei com: HTML, CSS, JavaScript, Jquery, Bootstrap, TypeScript, Angular, JSP, Java, Spring (mvc, boot, data, security, etc.), Struts, JDBC, JPA/Hibernate, Bancos de Dados Relacionais (PostgreSql, MySQl, DB2 e Oracle) e não relacionais (MongoDB), Maven, XML, Json, Junit, Mockito, Git, Tortoise, GitHub, GitLab, BitBucket e Metodologias Ágeis (Scrum e Kanban).</p>  
<br/>
