...
Sou um Desenvolvedor Java Jr. autodidata. No momento estou cursando Engenharia de Software na [UFC](https://www.quixada.ufc.br/), finalizando o bootcamp de Spring da [DevSuperior](https://devsuperior.com.br/bootcamp) e o curso de [Comunicação entre microsserviços](https://www.udemy.com/course/comunicacao-entre-microsservicos/) da Udemy. Sou empenhado em evoluir e colaborar no desenvolvimento das pessoas e projetos, busco sempre aprender novas tecnologias realizando cursos e desafios práticos constantemente.
